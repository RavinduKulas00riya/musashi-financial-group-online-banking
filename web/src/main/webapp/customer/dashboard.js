...
`;
    ...
    function setupTransferLaterCheckbox() {
    ...
    function connectWebSocket() {
        socket = new WebSocket("ws://localhost:8080/musashi-banking-system/customerDashboard");
        socket.onopen = () => {console.log("D WebSocket connected");}
        ...
        socket.onclose = () => console.log("D WebSocket closed");
    }
