        ...
        <div style="width: 100%; height: 73%; display: flex; flex-direction: column; justify-content: center; align-items: center;">
          ...
          <div class="details-div">
            <div class="input-container" onclick="hideError()">
              <input spellcheck="false" type="text" class="form-control animated-input" name="name" placeholder=" ">
              <label class="input-label">Full Name</label>
            </div>
            <div class="input-container" onclick="hideError()">
              <input spellcheck="false" type="text" class="form-control animated-input" name="email" placeholder=" ">
              <label class="input-label">Email Address</label>
            </div>
            <div class="input-container" onclick="hideError()">
              <input spellcheck="false" type="text" maxlength="10" class="form-control animated-input" name="mobile" placeholder=" ">
          ...
          <div class="passwords-div">
            ...
            <div class="input-container" onclick="hideError()">
              <input type="password" class="form-control animated-input" name="confirm-password" placeholder=" ">
              <label class="input-label">Confirm Password</label>
            </div>
            <div class="buttons medium">
              <button class="log-btn" style="height: 50px; font-size: 17px; border: none; border-radius: 10px; margin-bottom: 10px;" onclick="register('')">Create Account</button>
              <button style="height: 50px; font-size: 17px; border: none; border-radius: 10px; color: #007bff; margin-bottom: 10px; background-color: rgba(0, 123, 255, 0.05);" onclick="window.location.href='${pageContext.request.contextPath}/index.jsp'">I already have an Account</button>
            </div>
          </div>
